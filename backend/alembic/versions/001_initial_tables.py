...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('category', sa.String(), nullable=True, server_default='Infrastructure'),
    ...
    op.create_table(
        ...
        sa.Column('category', sa.String(), nullable=True, server_default='Clinical Residency'),
        sa.Column('duration', sa.String(), nullable=True, server_default='Intensive Masterclass'),
